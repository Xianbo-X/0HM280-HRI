...
def InitProxy(IP="marvin.local", proxy=[0], PORT = 9559):
    ...
    global dialogProxy
    ALModuleList=["ALTextToSpeech","ALAudioDevice","ALMotion","ALMemory","ALFaceDetection","ALVideoDevice","ALLeds","ALFaceTracker","ALSpeechRecognition","ALAudioPlayer","ALVideoRecorder","ALSonar","ALRobotPosture","ALLandMarkDetection","ALTracker","ALSoundDetection","ALAudioSourceLocalization","ALDialog"]
    proxyDict={}
    ...
    dialogProxy=proxyDict["ALDialog"]
